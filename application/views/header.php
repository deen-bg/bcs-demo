...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/jquery.scrollbar.css');?>"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/dreaming-attribute.css');?>"/>
                        ...
                        <div class="box-header-nav menu-nocenter">
                            <ul id="menu-primary-menu"
                                ...
                                <li id="menu-item-238"
                                    ...
                                    <a class="kobolg-menu-item-title" title="Free Shipping on Orders $100" href="#">ช้อปครบ 500 บาท ส่งฟรีทั่วประเทศ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
